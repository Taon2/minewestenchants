...
import net.minewest.minewestenchants.events.ArmorEquipEvent.EquipMethod;
...
public class ArmorEquipListener implements Listener{
    ...
    private static final List<Material> blockedMaterials;

    static {
        blockedMaterials = Arrays.asList(
                Material.CHEST,
    ...
    public void playerInteractEvent(PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (e.getClickedBlock() != null && e.getAction() == Action.RIGHT_CLICK_BLOCK) {// Having both of these checks is useless, might as well do it though.
                ...
                for (Material m : blockedMaterials) {
                    if (mat.equals(m)) return;
                }
            }
